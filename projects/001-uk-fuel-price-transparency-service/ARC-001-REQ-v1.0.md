...
- Consumer mobile app (rely on third-party apps consuming the open API)
...
- Year 2: 9,000 forecourts (new builds), 3M monthly citizen users, 50 third-party integrations
- Year 3: 10,000 forecourts (potentially including EV charging), 5M monthly users, 100+ third-party integrations
...
**Generation Context**: Requirements derived from ARC-000-PRIN-v1.0 (Architecture Principles), ARC-001-STKE-v1.0 (Stakeholder Drivers & Goals), GOV.UK Fuel Finder guidance, and CMA enforcement guidance.
